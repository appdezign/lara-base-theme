...
@section('scripts-after')
	...
	<script>
		(function () {
			...
			const form = document.getElementById('{{ $entity->getEntityKey() }}-form');
			const ajaxResponse = document.getElementById('{{ $entity->getEntityKey() }}-response');
			const submit = document.getElementById('{{ $entity->getEntityKey() }}-submit-button');
