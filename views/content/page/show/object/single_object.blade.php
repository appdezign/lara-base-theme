...
@elseif($data->object->hasVideos() && $data->object->hasFeatured())
	...
	<div class="position-relative rounded-3 overflow-hidden mt-16 mb-48">
		<div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center zindex-5">
			<a href="https://www.youtube.com/watch?v={{ $data->object->video->youtubecode }}"
		...
		@include('_img.lazy', ['lzobj' => $data->object->featured, 'lzw' => 1280, 'lzh' => 512, 'ar' => '5x2', 'cl' => 'd-block w-100'])
	</div>

@elseif($data->object->hasFeatured() && !$data->object->heroIsFeatured())
