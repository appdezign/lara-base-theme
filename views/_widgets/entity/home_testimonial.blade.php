						...
						<a href="#testimonial-{{ $widgetObject->id }}"
						   ...
						   data-bs-toggle="tab" role="tab">
							@if($widgetObject->hasFeatured())
								@include('_img.lazy', ['lzobj' => $widgetObject->featured, 'lzw' => 96, 'lzh' => 96, 'dw' => 56, 'dh' => 56,'ar' => '1x1', 'cl' => 'rounded-circle', 'cnt' => true, 'cntclass' => 'me-md-16 me-sm-0 me-16 mb-md-0 mb-sm-8'])
							@endif
							<div>
