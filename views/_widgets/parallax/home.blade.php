@if(!empty($widgetsliders))
	...
	<section class="jarallax dark-mode bg-dark py-xxl-48" data-jarallax data-speed="0.4">
		...
		<div class="jarallax-img" style="background-image: url({{ _cimg($widgetsliders->first()->featured->filename, 1920, 960) }});"></div>
							...
							<div class="swiper-wrapper">
								...
								@foreach($widgetsliders as $widgetslider)
									...
									<div class="swiper-slide">
										...
										{!! _header('list', $widgetslider->title , 'display-2 from-start mb-lg-24', $headerTag->listTag, $headerTag->id) !!}
